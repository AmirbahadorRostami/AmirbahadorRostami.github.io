...
field2D.prototype.diffuse = function (sourcefield, diffusion, passes) {
  ...
  const w = sourcefield.width,
    h = sourcefield.height;
    ...
    for (var y = 0; y < h; y++) {
      for (var x = 0; x < w; x++) {
        ...
        for (let i = 0; i < 4; i++) {
          const old = input[C + i];
          const near =
            array[W + i] + array[E + i] + array[S + i] + array[N + i];
...
field2D.prototype.draw = function () {
  ...
  ctx.drawImage(this.canvas, 0, 0, w, w, 0, 0, 1, 1);
...
field2D.prototype.index_clamped = function (pos) {
...
field2D.prototype.viewDot4 = function (idx, v) {
  return (
    v[0] * this.data[idx + 0] +
    v[1] * this.data[idx + 1] +
    v[2] * this.data[idx + 2] +
...
vec2.prototype.anglebetween = function (v) {
  return vec2.anglebetween(this, v);
};
vec2.prototype.oob = function (lo, hi) {
  return vec2.oob(this, lo, hi);
};
...
vec2.prototype.setmag = function (a) {
  return vec2.setmag(this, this, a);
};
vec2.prototype.setangle = function (a) {
  return vec2.setangle(this, this, a);
};
vec2.prototype.add = function (b) {
  return vec2.add(this, this, b);
};
vec2.prototype.sub = function (b) {
  return vec2.sub(this, this, b);
};
vec2.prototype.absdiff = function (b) {
  return vec2.absdiff(this, this, b);
};
vec2.prototype.mul = function (b) {
  return vec2.mul(this, this, b);
};
vec2.prototype.div = function (b) {
  return vec2.div(this, this, b);
};
vec2.prototype.pow = function (x, y) {
  return vec2.pow(this, this, x, y);
};
vec2.prototype.max = function (x, y) {
  return vec2.max(this, this, x, y);
};
vec2.prototype.min = function (x, y) {
  return vec2.min(this, this, x, y);
};
vec2.prototype.greater = function (b) {
  return vec2.greater(this, this, b);
};
vec2.prototype.lesser = function (b) {
  return vec2.lesser(this, this, b);
};
vec2.prototype.clip = function (lo, hi) {
  return vec2.clip(this, this, lo, hi);
};
vec2.prototype.mix = function (b, t) {
  return vec2.mix(this, this, b, t);
};
vec2.prototype.wrap = function (x, y) {
  return vec2.wrap(this, this, x, y);
};
vec2.prototype.relativewrap = function (x, y) {
  return vec2.relativewrap(this, this, x, y);
};
...
vec2.prototype.limit = function (m) {
  return vec2.limit(this, this, m);
};
vec2.prototype.rotate = function (a) {
  return vec2.rotate(this, this, a);
};
...
let make_vec2_fun = function (f) {
  // hack because of JS scope annoyance
  return function () {
    return f.apply(new vec2(), arguments);
  };
};
...
class hashspace2D {
  ...
  removePoint(item) {
    ...
    var v = item.__spacehash.cellV,
      h = item.__spacehash.cellH;
  ...
  updatePoint(item) {
    // old location
    var ov = item.__spacehash.cellV,
      oh = item.__spacehash.cellH;
